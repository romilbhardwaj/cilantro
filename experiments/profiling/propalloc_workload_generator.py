    ...
    def generate_cilantro_client_objects(self,
        ...
        cilantroclient_dep = get_template_deployment(
            ...
            container_command=["python",
                               "/cilantro/experiments/profiling/workloads/dummy_workload_driver.py"],
            container_args=["--k8s-app-name", app_name, "--grpc-port",
                            "$(CILANTRO_SERVICE_SERVICE_PORT)", "--grpc-ip",
                            "$(CILANTRO_SERVICE_SERVICE_HOST)", "--grpc-client-id", app_name],

#!/usr/bin/env bash
# Runs the Cilantro scheduler and client for the cluster sharing experiment on eks
# Usage:
#   ./starters/launch_cilantro_driver.sh <CONFIG_PATH> <POLICY>
# Example:
#   ./starters/launch_cilantro_driver.sh ~/.kube/config greedyegal
...
kubectl apply -f ./starters/cilantro_cfgs/config_cilantro_scheduler_${POLICY}.yaml --kubeconfig ${CONFIG_PATH}

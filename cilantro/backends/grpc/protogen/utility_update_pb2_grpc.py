...
import cilantro.backends.grpc.protogen.utility_update_pb2 as utility__update__pb2


class UtilityMessagingStub(object):
    """Interface exported by the cilantro server
    """
    ...
    def __init__(self, channel):
        ...
        self.PublishUtility = channel.unary_unary(
                '/cilantro.UtilityMessaging/PublishUtility',
...
def add_UtilityMessagingServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'cilantro.UtilityMessaging', rpc_method_handlers)
...
class UtilityMessaging(object):
    ...
    def PublishUtility(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/cilantro.UtilityMessaging/PublishUtility',

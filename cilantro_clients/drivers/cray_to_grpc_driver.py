"""
    This cilantro client fetches metrics from the ray logs and publishes them to the scheduler.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='A Cilantro client which fetches Ray logs and publishes them.')
    # Add parser args
    ...
    CrayLogParser.add_args_to_parser(parser)
    args = parser.parse_args()
    logger.info(f"Command line args: {args}")

    # log_parser = DummyLogParser()
    log_parser = CrayLogParser(slo_type=args.slo_type,
